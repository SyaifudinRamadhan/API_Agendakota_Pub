            ...
            <tr>
                <td class="o_bg-light o_px-xs" align="center"
                    ...
                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0"
                        ...
                        <tbody>
                            <tr>
                                @if ($forTrx && $trxStatus == true)
                                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffedf1;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px; text-align: center;">
                                        <h1 class="o_heading o_text-dark o_mb-xxs"
                                            style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 36px;line-height: 47px; text-align: center;">
                                        ...
                                        <p style="margin-top: 0px;margin-bottom: 0px; text-align: center;">+Transfer withdraw telah berhasil dilakukan otomatis ke rekening pengaju.</p>
                                    </td>
                                @elseif ($forTrx && $trxStatus == false)
                                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffedf1;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px; text-align: center;">
                                        <h1 class="o_heading o_text-dark o_mb-xxs"
                                            style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 36px;line-height: 47px; text-align: center;">
                                        ...
                                        <p style="margin-top: 0px;margin-bottom: 0px; text-align: center;">+Transfer withdraw gagal dilakukan otomatis ke rekening pengaju. Segera lakukan transfer manual ke no rekeing pengaju.</p>
                                    </td>
                                @else
                                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffedf1;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px; text-align: center;">
                                        <h1 class="o_heading o_text-dark o_mb-xxs"
                                            style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 36px;line-height: 47px; text-align: center;">
                                            Informasi Layanan</h1>
                                        <p style="margin-top: 0px;margin-bottom: 0px; text-align: center;">Seorang user melakukan pengajuan
                                ...
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    @if ($forTrx && $trxStatus == true)
                                        <p style="margin-top: 0px;margin-bottom: 0px;">Admin Notification.
                                            Widthdraw transfer dengan username "{{ $username }}" dan email "{{ $email }}",
                                            telah berhasil dilakukan otomatis. Dengan detail sebagai berikut.
                                    @elseif ($forTrx && $trxStatus == false)
                                        <p style="margin-top: 0px;margin-bottom: 0px;">Admin Notification.
                                            Widthdraw transfer dengan username "{{ $username }}" dan email "{{ $email }}",
                                            gagal dilakukan otomatis. Dengan detail sebagai berikut. Segera lakukan manual transfer ke no-rekening pengaju.
                                    @else
                                        <p style="margin-top: 0px;margin-bottom: 0px;">Admin Notification.
                                            User dengan username "{{ $username }}" dan email "{{ $email }}",
                                            telah melakukan pengajuan withdraw, dengan detail sebagai berikut. Segera cek sistem admin untuk memberifikasinya / approve.
                                    @endif
